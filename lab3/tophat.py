...
# TopHat -> różnica pomiędzy oryginałem a otwarciem (wewnątrz białych obszarów pojawiają się czarne kwadraty)
...
while(True):
    ...
    dilation = cv.morphologyEx(th, cv.MORPH_TOPHAT, kernel)
